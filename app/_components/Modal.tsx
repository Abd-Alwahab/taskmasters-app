...
export const ModalWindow = ({
  ...
  return createPortal(
    <div
      className={`fixed left-0 top-0 z-30 h-screen w-screen ${openName === name ? 'visible bg-[rgba(0,0,0,0.5)]  opacity-100 backdrop-blur transition-all' : 'pointer-events-none invisible opacity-0'}`}
    >
